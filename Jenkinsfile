    ...
    stages {
        ...
        stage ('Publish artifact to a folder in the Ansible Controller'){
            steps {
                ...
                sh 'scp /home/jenkins-slave-01/workspace/pipeline/target/myproject-1.0.war jenkins-slave-01@10.0.1.12:/opt/latestwar/latest.war'
            }
        }
            ...
            steps {
                ...
                [sshPublisherDesc(
                    ...
                    transfers: [
                        sshTransfer(
                                cleanRemote:false,
                                execCommand: 'ansible-playbook /home/ansibleadmin/deploy_docker.yaml -i /home/ansibleadmin/hosts',
                                execTimeout: 120000
                        )
                    ], 
