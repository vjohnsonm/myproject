    ...
    stages {
        ...
        stage ('Publish artifact to a folder in the Ansible Controller'){
            steps {
                ...
                sh 'scp jenkins-slave-01@10.0.1.11:/home/jenkins-slave-01/workspace/pipeline/target/myproject-0.0.1.war jenkins-slave-01@10.0.1.12:/opt/latestwar/latest.war'
            }
        }
